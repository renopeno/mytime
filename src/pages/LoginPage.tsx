      ...
      <div className="relative flex flex-col items-center justify-center overflow-hidden bg-primary px-8 py-12 lg:w-1/2 lg:py-0">
        ...
        <div className="relative z-10 max-w-md text-center lg:text-left">
          ...
          <div className="mb-8 flex items-center justify-center gap-3 lg:justify-start">
            ...
            <span className="font-serif text-4xl font-normal tracking-tight text-primary-foreground">
              MyTime
            </span>
          </div>

          {/* Tagline */}
          <h2 className="mb-4 font-serif text-3xl font-normal leading-tight text-primary-foreground lg:text-4xl">
            Track your time.
            <br />
